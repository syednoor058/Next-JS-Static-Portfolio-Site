import { BlurTextAnimationP, BlurTextAnimationSpan } from "@/components/ui/BlurTextAnimation";
...
export const metadata: Metadata = {
  ...
  description:
    "Professional full-stack development, SaaS solutions, API integration, and performance optimization tailored for modern businesses.",
};
        ...
        <div className="relative z-1">
          ...
          <div className="max-w-2xl flex flex-row gap-5 lg:absolute lg:top-1/3 lg:left-14 z-5 mt-10 px-4 md:px-8 lg:px-0">
            <span className="flex justify-center items-center">
              <h1
                className="rotate-180 uppercase text-nowrap text-[2.5vw] lg:text-[1.5vw] text-[#1b1b1b] font-medium"
                style={{ writingMode: "vertical-rl" }}
              >
                <BlurTextAnimationSpan text="Build Focus" delay={300} />
              </h1>
            </span>
            <FadeIn delay={0.3} className="w-px h-auto bg-gold">
              <div ></div>
            </FadeIn>
            <p className="text-[6vw] lg:text-[4vw] font-semibold leading-none pb-10 pl-10">
              <BlurTextAnimationP
                text="Engineering scalable web solutions with clarity, performance, and intent."
                delay={50}
              />
            </p>
          </div>
