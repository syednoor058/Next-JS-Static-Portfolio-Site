    ...
    <>
      <section className="w-full relative text-primary bg-black section-container">
        ...
        <div className="relative z-1">
            <h1 className="w-full text-center uppercase text-[10vw] text-white font-medium font-marcellus relative leading-none flex items-center justify-center">
              <BlurTextAnimationSpan text="Terms of Service" delay={300} />
            </h1>
        </div>
      </section>
